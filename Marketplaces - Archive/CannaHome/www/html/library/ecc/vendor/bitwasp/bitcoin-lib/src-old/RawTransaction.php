...
class RawTransaction
{
     ...
     * @return    boolean
     */
    public static function validate_signed_transaction($raw_tx, $json_string, $magic_byte = null, $magic_p2sh_byte = null, &$signatures = 0)
    {
        $magic_byte = BitcoinLib::magicByte($magic_byte);
        $magic_p2sh_byte = BitcoinLib::magicP2SHByte($magic_p2sh_byte);
     ...
     * @return  string|FALSE
     */
    public static function create($inputs, $outputs, $magic_byte = null, $magic_p2sh_byte = null, $lock_Time = null)
    {
        $magic_byte = BitcoinLib::magicByte($magic_byte);
        $magic_p2sh_byte = BitcoinLib::magicP2SHByte($magic_p2sh_byte);
        ...
        foreach ($inputs as $i => $input) {
            ...
            $tx_array['vin'][] = array('txid' => $input['txid'],
                'vout' => $input['vout'],
                'sequence' => (isset($input['sequence'])) ? $input['sequence'] : isset($lock_Time)
							? 4294967294
							: 4294967295,
                'scriptSig' => array('hex' => '')
            );
