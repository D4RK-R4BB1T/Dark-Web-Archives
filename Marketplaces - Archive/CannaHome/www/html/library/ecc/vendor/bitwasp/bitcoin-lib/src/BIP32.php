...
class BIP32
{
    ...
    // Bitcoin BIP39 (Segwit)
    public static $bitcoin_mainnet_bip39_public = '049d7cb2';
    public static $bitcoin_mainnet_bip39_private = '049d7878';
    public static $bitcoin_mainnet_bip39_version = '05';
    // Bitcoin BIP84 (Bech32 Segwit)
    public static $bitcoin_mainnet_bip84_public = '04b24746';
    public static $bitcoin_mainnet_bip84_private = '04b2430c';
    // Dogecoin
    ...
    public static function describe_magic_bytes($magic_bytes)
    {
        ...
        switch ($magic_bytes) {
            ...
            case self::$bitcoin_mainnet_bip39_public:
                $key['type'] = 'public';
                $key['testnet'] = false;
                $key['network'] = 'bitcoin';
                $key['version'] = self::$bitcoin_mainnet_bip39_version;
                break;
            case self::$bitcoin_mainnet_bip39_private:
                $key['type'] = 'private';
                $key['testnet'] = false;
                $key['network'] = 'bitcoin';
                $key['version'] = self::$bitcoin_mainnet_bip39_version;
            ...
            case self::$bitcoin_mainnet_bip84_public:
                $key['type'] = 'public';
                $key['testnet'] = false;
                $key['network'] = 'bitcoin';
                $key['version'] = self::$bitcoin_mainnet_version;
                break;
            case self::$bitcoin_mainnet_bip84_private:
                $key['type'] = 'private';
                $key['testnet'] = false;
                $key['network'] = 'bitcoin';
                $key['version'] = self::$bitcoin_mainnet_version;
