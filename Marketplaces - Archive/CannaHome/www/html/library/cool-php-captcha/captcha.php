...
class SimpleCaptcha {
    ...
    /** Background Text **/
    public $backgroundText = null;
    public $backgroundTextColor = null;
    ...
    protected function ImageAllocate() {
        ...
        if ($this->backgroundTextColor == null)
        	$this->backgroundTextColor = 'rgba(' . implode($color, ',') . ',0.8)';
    ...
    protected function WriteImage() {
        ...
        if ($this->backgroundText){
        	...
        	$draw->setFillColor($this->backgroundTextColor);
        	$draw->setFontSize(15);
