...
<div class="mm-modal">
    ...
    @endif
    <div class="modal animated fadeIn" id="mm-modal_{{ $id }}" tabindex="-1" role="dialog" aria-labelledby="mm-modal-label_{{ $id }}">
        <label class="modal-backdrop fade" for="mm-modal-toggle_{{ $id }}_hide"></label>
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <label for="mm-modal-toggle_{{ $id }}_hide" class="close" data-dismiss="modal" aria-label="Закрыть" style="display: flex; align-items: center;">
