            ...
            <form role="form" action="" method="post">
                ...
                <div class="well block">
                    ...
                    <div class="row">
                        <div class="col-xs-24">
                            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                <input id="title" type="text" class="form-control" name="title" placeholder="Название страницы" value="{{ old('title') ?: $page->title }}" required {{ autofocus_on_desktop() }}>
                                @if ($errors->has('title'))
                    ...
                    <div class="row">
                        <div class="col-xs-24">
                            <div class="form-group{{ $errors->has('body') ? ' has-error' : '' }}">
                                <textarea rows="15" class="form-control" name="body" placeholder="Содержимое страницы..." required>{{ old('body') ?: $page->body }}</textarea>
                                @if ($errors->has('body'))
                                    <span class="help-block">
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-orange">Отредактировать страницу</button>
                        &nbsp;
