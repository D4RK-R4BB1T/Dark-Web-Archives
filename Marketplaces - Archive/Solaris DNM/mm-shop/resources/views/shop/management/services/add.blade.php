...
@section('title', 'Добавление платной услуги')
...
@section('content')
    ...
    [
        ...
        ['title' => 'Добавление платной услуги']
    ]])
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-lg-13 animated fadeIn">
            <div class="well block">
                <h3>Добавление платной услуги</h3>
                <hr class="small" />
                <form action="" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                <input id="title" type="text" class="form-control" name="title" placeholder="Опишите услугу" value="{{ old('title') }}" required {{ autofocus_on_desktop() }}>
                                @if ($errors->has('title'))
                        ...
                        <div class="col-xs-6">
                            <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                                <input id="price" type="text" class="form-control" name="price" placeholder="Стоимость" value="{{ old('price') }}" required>
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-orange">Создать услугу</button>
                    </div>
                </form>
            </div>
        </div> <!-- /.col-sm-12 -->
