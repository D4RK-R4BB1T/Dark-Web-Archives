...
@section('title', 'Удаление платной услуги')
        ...
        <div class="col-sm-12 col-lg-13 animated fadeIn">
            <form action="" method="post">
                ...
                <div class="well block good-info">
                    <h3>Удаление платной услуги</h3>
                    <hr class="small" />
                    <p>Вы действительно хотите удалить данную платную услугу? Данная операция необратима.</p>
                    <hr class="small" />
