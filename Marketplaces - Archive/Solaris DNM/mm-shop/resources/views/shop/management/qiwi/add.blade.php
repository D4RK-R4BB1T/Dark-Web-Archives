    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-lg-13 animated fadeIn">
            <div class="well block">
                <h3>Добавление QIWI-кошелька</h3>
                <hr class="small" />
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="form-group{{ $errors->has('login') ? ' has-error' : '' }}">
                                <input id="login" type="text" class="form-control" name="login" placeholder="Номер кошелька (11 цифр)" value="{{ old('login') }}" required {{ autofocus_on_desktop() }}>
                                @if ($errors->has('login'))
                        ...
                        <div class="col-xs-12">
                            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                <input id="password" type="password" class="form-control" name="password" placeholder="Пароль" value="" required>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="form-group{{ $errors->has('daily_limit') ? ' has-error' : '' }}">
                                <input id="daily_limit" type="text" class="form-control" name="daily_limit" placeholder="Дневной лимит" value="{{ old('daily_limit') }}" required>
                        ...
                        <div class="col-xs-12">
                            <div class="form-group{{ $errors->has('monthly_limit') ? ' has-error' : '' }}">
                                <input id="monthly_limit" type="text" class="form-control" name="monthly_limit" placeholder="Месячный лимит" value="{{ old('monthly_limit') }}" required>
