            ...
            <div class="well block">
                ...
                <div class="text-center">
                    @if (Auth::user()->totp_key)
                        <a class="btn btn-orange" href="{{ url("/settings/security/2fa/otp/disable") }}">Отключить</a>
                    @elseif (Auth::user()->pgp_key)
                        <a class="btn btn-orange" href="{{ url("/settings/security/2fa/pgp/disable") }}">Отключить</a>
                    @else
