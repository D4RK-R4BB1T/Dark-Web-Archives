        ...
        <div class="row">
            <div class="col-sm-12" style="border-right: 1px solid #ccc;">
                <div class="text-center">
                    ...
                    <br />
                    <a class="btn btn-orange" href="{{ url("/settings/security/2fa/otp/enable") }}">Использовать OTP</a>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="text-center">
                    ...
                    <br />
                    <a class="btn btn-orange" href="{{ url("/settings/security/2fa/pgp/enable") }}">Использовать PGP</a>
                </div>
            </div>
        </div>
